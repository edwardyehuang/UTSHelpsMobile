...
namespace UTSHelps.View
{
	public class MySelfPage : ContentPage
	{
		...
		public PickerEx degreePicker = new PickerEx
		{
			Title = "Degree",
			HorizontalOptions = LayoutOptions.FillAndExpand,
		...
		public PickerEx statusPicker = new PickerEx
		{
			Title = "Status",
			HorizontalOptions = LayoutOptions.FillAndExpand,
			Dictionary = new Dictionary<string, string>
		...
		// year
		public PickerEx yearPicker = new PickerEx
		{
			Title = "Year",
			HorizontalOptions = LayoutOptions.FillAndExpand,
			Dictionary = new Dictionary<string, string>
		...
		// Gender
		public PickerEx genderPicker = new PickerEx
		{
			Title = "Gender",
			HorizontalOptions = LayoutOptions.FillAndExpand,
			Dictionary = new Dictionary<string, string>
		...
		// country
		public PickerEx countryPicker = new PickerEx
		{
			Title = "Country",
			HorizontalOptions = LayoutOptions.FillAndExpand,
		};
		...
		// language
		public PickerEx langPicker = new PickerEx
		{
			Title = "Language",
			HorizontalOptions = LayoutOptions.FillAndExpand,
		};
